            ...
            <div class="content">
                <div class="row">
                    ...
                    <?php 
                                              ...
                                              $sql = "SELECT SUM(totalAmount) FROM sales WHERE saleDate >= DATE_SUB(CURDATE(), INTERVAL 1 YEAR)";
                                              $stmt = $conn->prepare($sql);
                                              $stmt->execute();
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="detail">
                            ...
                            <span class="number"><?php echo  $_COOKIE['medicine']+$_COOKIE['staff'];+$_COOKIE['orders']+$_COOKIE['sales']; ?></span>
                        </div>
                    </div>
                </div>
                <div class="footer">
