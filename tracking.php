        ...
        <div class="content">
            <div class="container mt-4">
                ...
                if ($result_most_sold->num_rows > 0) {
                    ...
                    $mostSoldProductID = trim($row_most_sold['productName']);
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end"><?php echo $_COOKIE['sales']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>/orders.php <a href="my_php/orders.php"><i
                                                                class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end"><?php echo $_COOKIE['orders']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>/dashboard.php <a href="#"><i
                                                                class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end"><?php echo $_COOKIE['dashboard']; ?></td>
                                                </tr>
