                        ...
                        <li class="nav-item dropdown">
                            <div class="nav-dropdown">
                                <a href="#" id="nav2" class="nav-item nav-link dropdown-toggle text-secondary" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fas fa-user"></i> <span><?php echo $_SESSION['fullname'];?></span> <i style="font-size: .8em;" class="fas fa-caret-down"></i>
                                </a>
                                ...
                                <div class="content">
                                    ...
                                    <div class="canvas-wrapper">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>/medicine.html <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end"><?php echo $_COOKIE['pageViews']; ?></td>
                                                </tr>
                                                <tr>
